...
*Links* para acessar a página inicial das notas de aulas via [Github](https://github.com), [Binder](https://beta.mybinder.org/) e [Google Colab](http://colab.research.google.com):
...
- Há um *branch* livro que contém um livro texto para a disciplina, mas que ainda está em uma fase bastante preliminar e não está sendo muito utilizado na matéria. A ideia, no entanto, é que o livro seja aprimorado aos poucos e que seja mais útil em uma das próximas edições da disciplina.
